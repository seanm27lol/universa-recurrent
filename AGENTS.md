...
- The repository includes classical and exploratory neural paths. Name the exact version and never present an exploratory run as a sealed scientific result.
...
- Use the direct solver and appropriate iterative baselines. Include setup,
  routing, logging, checking, and preprocessing in claimed total costs.
...
- Match changes to tests, the relevant explanation, and the claim ledger.
